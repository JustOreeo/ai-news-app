intent('What does this app do?', 'What can I do here?', 'What do you do?', 
      reply('This is an AI News App.'));

const API_KEY = '77409b21d7d846cbbce00b1f7e3d6643';
let savedArticles = [];
...
intent('What\'s up with $(term* (.*))', (p) => {
    ...
    api.request(NEWS_API_URL, (error, response, body) => {
        ...
        p.play({ command: 'newHeadlines', articles});
        p.play(`Here are the (latest|recent) news from ${p.term.value}`)
